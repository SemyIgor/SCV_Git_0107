...
## <u>8. Несколько советов по работе с терминалом</u>

> Для очистки окна терминала следует ввести команду <span style="color:green; font-family:courier; font-size:20px">clear</span>

> Для возврата управления терминалом после вывода в него информации при выполнении какой-нибудь команды, следует нажать клавишу `Q`. При этом, клавиатура должна быть переключена на английскую раскладку.
