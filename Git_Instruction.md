...
Переход в другую ветку выполняется той же командой, которой мы переходим к другому коммиту (сохранению), только вместо ID коммита мы вводим имя нужной ветки
...
Для того, чтобы слить ветки, надо выплнить команду `git merge Имя-присоединяемой-ветки`
